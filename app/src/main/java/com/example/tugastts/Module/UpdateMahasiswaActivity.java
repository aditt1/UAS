                ...
                builder.setMessage("Apakah anda yakin untuk mengubah data ini?")
                        .setNegativeButton("No", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(UpdateMahasiswaActivity.this, "Tidak jadi mengubah",
                                        Toast.LENGTH_SHORT).show();
                            }
                        })
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(UpdateMahasiswaActivity.this, "Melakukan Pengubahan !!",
                                        Toast.LENGTH_SHORT).show();
                                Intent i = new Intent(UpdateMahasiswaActivity.this, AdminActivity.class);
                                startActivity(i);
                            }
                        });
