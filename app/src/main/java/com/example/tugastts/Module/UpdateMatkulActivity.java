                ...
                builder.setMessage("Apakah anda yakin untuk mengubah data ini?")
                        .setNegativeButton("No", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(UpdateMatkulActivity.this, "Tidak jadi mengubah",
                                        Toast.LENGTH_SHORT).show();
                            }
                        })
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            public void onClick(DialogInterface dialog, int which) {
                                Toast.makeText(UpdateMatkulActivity.this, "Melakukan Pengubahan !!",
                                        Toast.LENGTH_SHORT).show();
                                Intent i = new Intent(UpdateMatkulActivity.this, AdminActivity.class);
                                startActivity(i);
                            }
                        });
